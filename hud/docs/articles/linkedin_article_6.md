...
<div align="center">
  <img src="./imgs/ed_glowing.gif" width="600" style="border-radius: 8px;"/>
</div>
...
- [ollama-plugin.component.ts](https://github.com/cesardraw2/glances/blob/docs/linkedin-series/hud/frontend/src/app/plugins/ollama-plugin.component.ts)
