...
<div align="center">
  <img src="./imgs/ed_cockpit.gif" width="600" style="border-radius: 8px;"/>
</div>
...
- [metrics.service.spec.ts](https://github.com/cesardraw2/glances/blob/develop/hud/frontend/src/app/services/metrics.service.spec.ts)
- [metrics.service.ts](https://github.com/cesardraw2/glances/blob/develop/hud/frontend/src/app/services/metrics.service.ts)
